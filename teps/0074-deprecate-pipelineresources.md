...
in it's current form. The existing benefits this provides would be replaced with:

- In the long run [TEP-0044](https://github.com/tektoncd/community/blob/main/teps/0044-decouple-task-composition-from-scheduling.md)
  will provide the ability to combine Tasks and allow them to run within one pod (initially as we explore this TEP,
...
TODO: include new repo for pipelinereesource images with own release cadence
